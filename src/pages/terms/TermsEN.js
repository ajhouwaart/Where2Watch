function TermsEN() {
    ...
    return (
        <>
            ...
            <p>Welcome to Where 2 Watch!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Where2Watch's
                Website, located at www.where2watch.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                Where 2 Watch if you do not agree to take all of the terms and conditions stated on this
                page.</p>
            ...
            <p>We employ the use of cookies. By accessing Where 2 Watch, you agreed to use cookies in agreement
                with the Where2Watch's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Where2Watch and/or its licensors own the intellectual property rights
                for all material on Where 2 Watch. All intellectual property rights are reserved. You may access
                this from Where 2 Watch for your own personal use subjected to restrictions set in these terms
                and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Where 2 Watch</li>
                <li>Sell, rent or sub-license material from Where 2 Watch</li>
                <li>Reproduce, duplicate or copy material from Where 2 Watch</li>
                <li>Redistribute content from Where 2 Watch</li>
            </ul>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                information in certain areas of the website. Where2Watch does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments do not reflect the views and
                opinions of Where2Watch,its agents and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent permitted by applicable laws,
                Where2Watch shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
                Comments on this website.</p>

            <p>Where2Watch reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant Where2Watch a non-exclusive license to use, reproduce, edit and authorize others
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                ...
                hyperlink compensates the absence of Where2Watch; and (d) the link is in the context of general
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                our website, you must inform us by sending an e-mail to Where2Watch. Please include your name,
            ...
            <p>No use of Where2Watch's logo or other artwork will be allowed for linking absent a trademark
                license agreement.</p>
